...
advanced applications, such as training custom classifiers and
validation, users should use the ‘BirdNET Analyzer’ directly. `birdnetR`
...
This is a simple example using the `tflite` BirdNET model to predict
species in an audio file.
