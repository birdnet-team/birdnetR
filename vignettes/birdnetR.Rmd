...
`arrow::read_parquet()`), you need the `arrow` package installed. On Linux
this may require compilation and can take several minutes. Use
`install_arrow()` as a convenience wrapper, or install `arrow` directly:
